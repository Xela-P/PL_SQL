var _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {},
    Prism = function (e) {
            ...
            s = {
                    ...
                    clone: function e(t, a) {
                        ...
                        switch (a = a || {}, s.util.type(t)) {
                            case "Object":
                                ...
                                return n;
                            case "Array":
                                return r = s.util.objId(t), a[r] ? a[r] : (n = [], a[r] = n, t.forEach((function (t, s) {
                                    n[s] = e(t, a)
                                })), n);
                            default:
                                return t
                ...
                languages: {
                    ...
                    insertBefore: function (e, t, a, n) {
                        ...
                        return n[e] = i, s.languages.DFS(s.languages, (function (t, a) {
                            a === u && t != e && (this[t] = i)
                        })), i
                    },
                    DFS: function e(t, a, n, r) {
                        ...
                        for (var o in t)
                            if (t.hasOwnProperty(o)) {
                                ...
                                var l = t[o],
                                    u = s.util.type(l);
                                "Object" !== u || r[i(l)] ? "Array" !== u || r[i(l)] || (r[i(l)] = !0, e(l, a, o, r)) : (r[i(l)] = !0, e(l, a, null, r))
                            }
                    }
                },
                plugins: {},
                ...
                highlightElement: function (t, a, n) {
                    ...
                    function u(e) {
                        l.highlightedCode = e, s.hooks.run("before-insert", l), l.element.innerHTML = l.highlightedCode, s.hooks.run("after-highlight", l), s.hooks.run("complete", l), n && n.call(l.element)
                    }
                    if (s.hooks.run("before-sanity-check", l), (o = l.element.parentElement) && "pre" === o.nodeName.toLowerCase() && !o.hasAttribute("tabindex") && o.setAttribute("tabindex", "0"), !l.code) return s.hooks.run("complete", l), void(n && n.call(l.element));
                ...
                highlight: function (e, t, a) {
                    ...
                    if (s.hooks.run("before-tokenize", n), !n.grammar) throw new Error('The language "' + n.language + '" has no grammar.');
                    return n.tokens = s.tokenize(n.code, n.grammar), s.hooks.run("after-tokenize", n), r.stringify(s.util.encode(n.tokens), n.language)
                },
                tokenize: function (e, t) {
                    ...
                    var s = new l;
                    return u(s, s.head, e), o(e, s, t, s.head, 0),
                        function (e) {
                            var t = [],
                                a = e.head.next;
            ...
            for (var p in a)
                if (a.hasOwnProperty(p) && a[p]) {
                    ...
                    for (var m = 0; m < g.length; ++m) {
                        ...
                        for (var w = f.pattern || f, F = n.next, P = l; F !== t.tail && !(d && P >= d.reach); P += F.value.length, F = F.next) {
                            var S = F.value;
                            ...
                            if (!(S instanceof r)) {
                                ...
                                if (y) {
                                    ...
                                    for (var T = F; T !== t.tail && (E < $ || "string" == typeof T.value); T = T.next) x++, E += T.value.length;
                                ...
                                var R = F.prev;
                                if (z && (R = u(t, R, z), P += z.length), c(t, R, x), F = u(t, R, new r(p, h ? s.tokenize(O, h) : O, k, O)), I && u(t, F, I), x > 1) {
                                    var D = {
                                        cause: p + "," + m,
                                        reach: N
                                    };
        ...
        if (e.Prism = s, r.stringify = function e(t, a) {
...
"undefined" != typeof module && module.exports && (module.exports = Prism), "undefined" != typeof global && (global.Prism = Prism), Prism.languages.markup = {
        ...
        if (void 0 !== Prism && "undefined" != typeof document) {
            ...
            Prism.hooks.add("before-highlightall", (function (e) {
                    ...
                    d && d.loadLanguages(u),
                        function (e, t, a) {
                            ...
                            if (a) {
                                ...
                                r < 0 && (r += s.length), r = Math.max(0, Math.min(r - 1, s.length)), l < 0 && (l += s.length), l = Math.max(0, Math.min(l, s.length)), e = s.slice(r, l).join("\n"), i.hasAttribute("data-start") || i.setAttribute("data-start", String(r + 1))
                            }
                ...
                highlight: function (e) {
                    for (var t, a = (e || document).querySelectorAll(s), n = 0; t = a[n++];) Prism.highlightElement(t)
                }
            };
            var r = !1;
                                ...
                                if ("string" == typeof u || u.content && "string" == typeof u.content) {
                                    ...
                                    if (m > -1) {
                                        ...
                                        var f = p.substring(0, m),
                                            ...
                                            y = [];
                                        f && y.push.apply(y, i([f])), y.push(h), b && y.push.apply(y, i([b])), "string" == typeof u ? o.splice.apply(o, [l, 1].concat(y)) : u.content = y
                                    }
    ...
    function (e) {
        ...
        e.languages.bash = {
            ...
            variable: n.variable,
            function: {
                pattern: /(^|[\s;|&]|[<>]\()(?:add|apropos|apt|apt-cache|apt-get|aptitude|aspell|automysqlbackup|awk|basename|bash|bc|bconsole|bg|bzip2|cal|cat|cfdisk|chgrp|chkconfig|chmod|chown|chroot|cksum|clear|cmp|column|comm|composer|cp|cron|crontab|csplit|curl|cut|date|dc|dd|ddrescue|debootstrap|df|diff|diff3|dig|dir|dircolors|dirname|dirs|dmesg|docker|docker-compose|du|egrep|eject|env|ethtool|expand|expect|expr|fdformat|fdisk|fg|fgrep|file|find|fmt|fold|format|free|fsck|ftp|fuser|gawk|git|gparted|grep|groupadd|groupdel|groupmod|groups|grub-mkconfig|gzip|halt|head|hg|history|host|hostname|htop|iconv|id|ifconfig|ifdown|ifup|import|install|ip|jobs|join|kill|killall|less|link|ln|locate|logname|logrotate|look|lpc|lpr|lprint|lprintd|lprintq|lprm|ls|lsof|lynx|make|man|mc|mdadm|mkconfig|mkdir|mke2fs|mkfifo|mkfs|mkisofs|mknod|mkswap|mmv|more|most|mount|mtools|mtr|mutt|mv|nano|nc|netstat|nice|nl|node|nohup|notify-send|npm|nslookup|op|open|parted|passwd|paste|pathchk|ping|pkill|pnpm|podman|podman-compose|popd|pr|printcap|printenv|ps|pushd|pv|quota|quotacheck|quotactl|ram|rar|rcp|reboot|remsync|rename|renice|rev|rm|rmdir|rpm|rsync|scp|screen|sdiff|sed|sendmail|seq|service|sftp|sh|shellcheck|shuf|shutdown|sleep|slocate|sort|split|ssh|stat|strace|su|sudo|sum|suspend|swapon|sync|tac|tail|tar|tee|time|timeout|top|touch|tr|traceroute|tsort|tty|umount|uname|unexpand|uniq|units|unrar|unshar|unzip|update-grub|uptime|useradd|userdel|usermod|users|uudecode|uuencode|v|vcpkg|vdir|vi|vim|virsh|vmstat|wait|watch|wc|wget|create|CREATE|Create|drop|Drop|DROP|table|TABLE|number|NUMBER|varchar|VARCHAR|char|CHAR|user|grant|whereis|which|who|whoami|write|xargs|xdg-open|yarn|yes|zenity|zip|zsh|zypper)(?=$|[)\s;|&])/,
                lookbehind: !0
            },
            keyword: {
                pattern: /(^|[\s;|&]|[<>]\()(?:case|do|NOT|IS|done|elif|else|esac|fi|for|function|if|in|select|then|from|until|while)(?=$|[)\s;|&])/,
                lookbehind: !0
            },
            builtin: {
        ...
        for (var s = ["comment", "function-name", "for-or-select", "assign-left", "string", "environment", "function", "keyword", "builtin", "boolean", "file-descriptor", "operator", "punctuation", "number"], r = n.variable[1].inside, i = 0; i < s.length; i++) r[s[i]] = e.languages.bash[s[i]];
    ...
    }), Prism.languages.markup && (Prism.languages.markup.tag.addInlined("script", "javascript"), Prism.languages.markup.tag.addAttribute(/on(?:abort|blur|change|click|composition(?:end|start|update)|dblclick|error|focus(?:in|out)?|key(?:down|up)|load|mouse(?:down|enter|leave|move|out|over|up)|reset|resize|scroll|select|slotchange|submit|unload|wheel)/.source, "javascript")), Prism.languages.js = Prism.languages.javascript, Prism.languages.scss = Prism.languages.extend("css", {
        comment: {
            pattern: /(^|[^\\])(?:\/\*[\s\S]*?\*\/|\/\/.*)/,
            lookbehind: !0
        },
    ...
    function (e) {
        ...
        operator: /[-+%=]=?|!=|:=|\*\*?=?|\/\/?=?|<[<=>]?|>[=>]?|[&|^~]/,
        punctuation: /[{}[\];(),.:]/
    }, Prism.languages.python["string-interpolation"].inside.interpolation.inside.rest = Prism.languages.python, Prism.languages.py = Prism.languages.python, Prism.languages.aspnet = Prism.languages.extend("markup", {
        "page-directive": {
            pattern: /<%\s*@.*%>/,
            alias: "tag",
            inside: {
    ...
    function () {
        if (void 0 !== Prism) {
            ...
            t.prototype = {
                ...
                normalize: function (t, a) {
                    for (var n in a = e(this.defaults, a)) {
                        ...
                        "normalize" !== n && "setDefaults" !== s && a[n] && this[s] && (t = this[s].call(this, t, a[n]))
                    }
                    return t
                },
                leftTrim: function (e) {
                ...
                breakLines: function (e, t) {
                    ...
                    for (var n = e.split("\n"), s = 0; s < n.length; ++s)
                        if (!(a(n[s]) <= t)) {
                            for (var r = n[s].split(/(\s+)/g), i = 0, o = 0; o < r.length; ++o) {
                                var l = a(r[o]);
                                (i += l) > t && (r[o] = "\n" + r[o], i = l)
                            }
                            n[s] = r.join("")
            ...
            }, "undefined" != typeof module && module.exports && (module.exports = t), Prism.plugins.NormalizeWhitespace = new t({
                "remove-trailing": !0,
                "remove-indent": !0,
                "left-trim": !0,
                "right-trim": !0
                ...
                if ((!e.settings || !1 !== e.settings["whitespace-normalization"]) && Prism.util.isActive(e.element, "whitespace-normalization", !0))
                    if (e.element && e.element.parentNode || !e.code) {
                        ...
                        if (e.code && a && "pre" === a.nodeName.toLowerCase()) {
                            for (var n = a.childNodes, s = "", r = "", i = !1, o = 0; o < n.length; ++o) {
                                var l = n[o];
                                l == e.element ? i = !0 : "#text" === l.nodeName && (i ? r += l.nodeValue : s += l.nodeValue, a.removeChild(l), --o)
                            }
